...
import type { ProductBrandListResponse } from "@/lib/types";

type Brand = ProductBrandListResponse["brands"][number];
...
function brandHref(brandId: number | null): string {
  ...
  return `/shop/search?product_brand_id=${brandId}&offset=1`;
}

export function ProductBrandSlider({ brands, activeBrandId }: Props) {
